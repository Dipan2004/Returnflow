...
class AcceptBuyerMatchUseCase:
    ...
    async def execute(self, buyer_id: str, return_id_str: str) -> OutcomeResponse:
        ...
        logger.info("Buyer accepted", return_id=return_id_str, buyer_id=buyer_id)
